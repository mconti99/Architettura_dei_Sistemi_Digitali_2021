...
HD_PWD='C:/Users/itama/Desktop/Architettura dei Sistemi Digitali/float_adder/float_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Float_Adder_On_Board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Float_Adder_On_Board.tcl -notrace
