...
HD_PWD='C:/Users/itama/Desktop/Architettura dei Sistemi Digitali/float_adder/float_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Float_Adder_On_Board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Float_Adder_On_Board.tcl
