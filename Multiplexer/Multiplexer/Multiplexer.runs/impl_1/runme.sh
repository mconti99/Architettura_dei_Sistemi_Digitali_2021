...
HD_PWD='C:/Users/itama/Desktop/Architettura dei Sistemi Digitali/Multiplexer/Multiplexer/Multiplexer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ConnectionNet.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ConnectionNet.tcl -notrace
