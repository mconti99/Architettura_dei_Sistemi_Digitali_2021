...
HD_PWD='C:/Users/itama/Desktop/Architettura dei Sistemi Digitali/Multiplexer/Multiplexer/Multiplexer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ConnectionNet.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ConnectionNet.tcl
